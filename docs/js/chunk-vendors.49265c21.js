"use strict";
(self["webpackChunkjjg_vue"] = self["webpackChunkjjg_vue"] || []).push([[504],{
...
const requestIdleCallback = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_9__/* .getGlobalThis */ .We)().requestIdleCallback || (cb => setTimeout(cb, 1));
const cancelIdleCallback = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_9__/* .getGlobalThis */ .We)().cancelIdleCallback || (id => clearTimeout(id));
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    const isAsyncSetup = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_9__/* .isPromise */ .yL)(setupResult);
    (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_10__/* .resetTracking */ .bl)();
    reset();
...
const patchProp = (el, key, prevValue, nextValue, namespace, parentComponent) => {
  ...
  el._isVueCE && (/[A-Z]/.test(key) || !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_8__/* .isString */ .Kg)(nextValue))) {
    patchDOMProp(el, (0,_vue_shared__WEBPACK_IMPORTED_MODULE_8__/* .camelize */ .PT)(key), nextValue, parentComponent, key);
  } else {
    if (key === "true-value") {
